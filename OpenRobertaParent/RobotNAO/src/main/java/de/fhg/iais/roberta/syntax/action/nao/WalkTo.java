...
public final class WalkTo<V> extends Action<V> {
    ...
    private WalkTo(Expr<V> walkToX, Expr<V> walkToY, Expr<V> walkToTheta, BlocklyBlockProperties properties, BlocklyComment comment, BlocklyError error) {
        super(BlockTypeContainer.getByName("WALK_DISTANCE"), properties, comment, error);
     ...
     */
    private static <V> WalkTo<V> make(Expr<V> walkToX, Expr<V> walkToY, Expr<V> walkToTheta, BlocklyBlockProperties properties, BlocklyComment comment, BlocklyError error) {
        return new WalkTo<V>(walkToX, walkToY, walkToTheta, properties, comment, error);
    }
