...
public final class MoveJoint<V> extends Action<V> {
    ...
    private MoveJoint(Joint joint, RelativeAbsolute relativeAbsolute, Expr<V> degrees, BlocklyBlockProperties properties, BlocklyComment comment, BlocklyError error) {
        super(BlockTypeContainer.getByName("MOVE_JOINT"), properties, comment, error);
    ...
    private static <V> MoveJoint<V> make(
        ...
        return new MoveJoint<V>(joint, relativeAbsolute, degrees, properties, comment, error);
    }
