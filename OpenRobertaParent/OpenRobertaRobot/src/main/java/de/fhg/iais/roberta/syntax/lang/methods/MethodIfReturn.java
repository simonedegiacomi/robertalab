...
public class MethodIfReturn<V> extends Method<V> {
    ...
    private MethodIfReturn(Expr<V> condition, BlocklyType returnType, Expr<V> returnValue, BlocklyBlockProperties properties, BlocklyComment comment, BlocklyError error) {
        super(BlockTypeContainer.getByName("METHOD_IF_RETURN"), properties, comment, error);
    ...
    public static <V> MethodIfReturn<V> make(
        ...
        return new MethodIfReturn<V>(condition, returnType, returnValue, properties, comment, error);
    }
