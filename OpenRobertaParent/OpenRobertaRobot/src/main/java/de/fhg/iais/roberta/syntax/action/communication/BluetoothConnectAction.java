...
public class BluetoothConnectAction<V> extends Action<V> {
    ...
    private BluetoothConnectAction(Expr<V> address, BlocklyBlockProperties properties, BlocklyComment comment, BlocklyError error) {
        super(BlockTypeContainer.getByName("BLUETOOTH_CONNECT_ACTION"), properties, comment, error);
     ...
     */
    public static <V> BluetoothConnectAction<V> make(Expr<V> address, BlocklyBlockProperties properties, BlocklyComment comment, BlocklyError error) {
        return new BluetoothConnectAction<V>(address, properties, comment, error);
    }
