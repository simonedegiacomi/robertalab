...
public class MathConst<V> extends Expr<V> {
    ...
    private MathConst(Const mathConst, BlocklyBlockProperties properties, BlocklyComment comment, BlocklyError error) {
        super(BlockTypeContainer.getByName("MATH_CONST"), properties, comment, error);
     ...
     */
    public static <V> MathConst<V> make(Const mathConst, BlocklyBlockProperties properties, BlocklyComment comment, BlocklyError error) {
        return new MathConst<V>(mathConst, properties, comment, error);
    }
    ...
    public static <V> Phrase<V> jaxbToAst(Block block, AbstractJaxb2Ast<V> helper) {
        ...
        return MathConst.make(MathConst.Const.get(field), helper.extractBlockProperties(block), helper.extractComment(block), helper.extractError(block));
    }
